...
// Alternate landing-page hero, rendered when VITE_SITE_VARIANT === 'ai'.
// Structure/motion/tokens are intentionally identical to <Hero />; only the
// copy differs and is left as TODO(COPY: alt hero) placeholders for now.
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col gap-5 pt-36 px-8 md:px-16 lg:px-24 max-w-xl">
        {/* Eyebrow */}
        {/* TODO(COPY: alt hero) — AI-PM tilt, Janu's voice */}
