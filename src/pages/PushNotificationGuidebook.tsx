...
// ─── App icons ──────────────────────────────────────────────────────────────
const I = {
  mmt:        { label: 'MMT',  bg: 'linear-gradient(135deg,#002f6c,#004494)', color: '#fff', fontSize: '8px' },
  duo:        { label: '🦉',  bg: '#58cc02',                                  color: '#fff', fontSize: '14px' },
  airbnb:     { label: '🏠',  bg: '#FF385C',                                  color: '#fff', fontSize: '13px' },
  tinder:     { label: '🔥',  bg: 'linear-gradient(135deg,#fd5564,#f06543)',  color: '#fff', fontSize: '13px' },
  phonepe:    { label: '₱',   bg: 'linear-gradient(135deg,#5f259f,#3d0d7e)',  color: '#fff', fontSize: '12px' },
  acko:       { label: 'A',   bg: '#1a237e',                                  color: '#fff', fontSize: '10px' },
  meesho:     { label: 'M',   bg: 'linear-gradient(135deg,#e91e8c,#c2185b)',  color: '#fff', fontSize: '11px' },
  navi:       { label: 'N',   bg: 'linear-gradient(135deg,#1e40af,#1d4ed8)',  color: '#fff', fontSize: '10px' },
  starbucks:  { label: '☕',  bg: '#00704a',                                  color: '#fff', fontSize: '13px' },
  motherdairy:{ label: 'MD',  bg: '#d32f2f',                                  color: '#fff', fontSize: '10px' },
  gmaps:      { label: 'G',   bg: '#fff',                                     color: '#EA4335', fontSize: '11px' },
  cred:       { label: 'CRED',bg: '#111',                                     color: '#c084fc', fontSize: '9px', letterSpacing: '0.02em' },
  jupiter:    { label: 'J',   bg: 'linear-gradient(135deg,#4f46e5,#3730a3)',  color: '#fff', fontSize: '11px' },
  amazon:     { label: 'a',   bg: '#232f3e',                                  color: '#ff9900', fontSize: '14px' },
  paytm:      { label: 'PAY', bg: '#00b9f1',                                  color: '#fff', fontSize: '9px' },
  zomato:     { label: 'Z',   bg: '#CB202D',                                  color: '#fff', fontSize: '10px' },
  healthify:  { label: 'H',   bg: 'linear-gradient(135deg,#00c853,#1b5e20)', color: '#fff', fontSize: '10px' },
  instagram:  { label: '📷', bg: 'linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366)', color: '#fff', fontSize: '12px' },
  linkedin:   { label: 'in',  bg: '#0077B5',                                  color: '#fff', fontSize: '10px' },
  grapevine:  { label: 'G',   bg: 'linear-gradient(135deg,#7c3aed,#5b21b6)', color: '#fff', fontSize: '11px' },
  netflix:    { label: 'N',   bg: '#E50914',                                  color: '#fff', fontSize: '10px' },
  ytmusic:    { label: '▶',  bg: '#FF0000',                                   color: '#fff', fontSize: '10px' },
  storytel:   { label: 'S',   bg: 'linear-gradient(135deg,#e94560,#9b1928)', color: '#fff', fontSize: '10px' },
} as const;
